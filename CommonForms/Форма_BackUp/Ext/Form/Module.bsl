...
&НаКлиенте
Процедура ОтправитьЛоги(Команда)
	РаботаСоСтатистикой_Сервер.ОтправитьСтатистикуНаСерверДанных();
КонецПроцедуры
//
//&НаКлиенте
...
//		Сообщение.Сообщить();
//	Иначе
		ЗагрузкаДанныхКлиент.ЗагрузитьДанные(Истина);
//	КонецЕсли;
КонецПроцедуры
//
//&НаКлиенте
...
//		Сообщение.Сообщить();
//	Иначе
		ВыгрузкаДанныхКлиент.ВыгрузитьДанные(Истина);
//	КонецЕсли;
КонецПроцедуры
//
//&НаКлиенте
