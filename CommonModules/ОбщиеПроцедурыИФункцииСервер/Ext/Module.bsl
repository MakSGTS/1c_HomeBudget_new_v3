...
//  Структура - Зарегестрировать учетную запись в системе:
// * Выполнено - Булево - 
// * ТекстОшибки - Строка - 
Функция ЗарегестрироватьУчетнуюЗаписьВСистеме(Логин, Пароль, ID_User) Экспорт
	ОтветРегистрации = РегистрыСведений.УчетныеЗаписи.ЗаписатьНовуюУчетнуюЗапись(Логин, ID_User, Пароль);
	Возврат ОтветРегистрации;
КонецФункции
