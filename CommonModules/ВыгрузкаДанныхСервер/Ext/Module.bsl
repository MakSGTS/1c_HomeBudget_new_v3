Функция ВыгрузитьДанные(Путь, ТолькоСправочники) Экспорт
	Возврат ВыгрузитьДанныеНоваяСхема(Путь, ТолькоСправочники);
КонецФункции
...
Функция ВыгрузитьДанныеНоваяСхема(Путь, ТолькоСправочники) Экспорт
	...
	Исключение
		...
		Текст = "Не удалось удалить временный файл после выгрузки." + Символы.ПС + ТексОшибки;
...
Функция Автобэкап(ВыгрузкаНаСервер, Каталог, Логин = Неопределено, Пароль = Неопределено) Экспорт
	...
	Ответ = ВыгрузитьДанныеНоваяСхема(КаталогВременныхФайлов(), Ложь);
